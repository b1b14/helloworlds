...
namespace AgendasMedicas.Controllers
{
    ...
    public class AgendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgendaId,PacienteId,MedicoId,DataConsuta,Status")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AgendaId,PacienteId,MedicoId,DataConsuta,Status")] Agenda agenda)
        {
