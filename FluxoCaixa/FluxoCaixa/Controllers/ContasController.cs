...
namespace FluxoCaixa.Controllers
{
    public class ContasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContaId,Nome,Valor,DataVencimento")] Conta conta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContaId,Nome,Valor,DataVencimento")] Conta conta)
        {
            if (id != conta.ContaId)
            {
                return NotFound();
